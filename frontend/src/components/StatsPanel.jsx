  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-12">
        <Loader className="w-8 h-8 text-indigo-400 spin" />
      </div>
    )
  }
    ...
    <div className="fade-in space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="glass rounded-lg p-6">
          ...
          <p className="text-4xl font-bold gradient-text">{stats.totalTitles}</p>
        </div>
        <div className="glass rounded-lg p-6">
          <p className="text-gray-400 text-sm mb-2">Total Scans</p>
          <p className="text-4xl font-bold gradient-text">{stats.totalScans}</p>
        </div>
        <div className="glass rounded-lg p-6">
          <p className="text-gray-400 text-sm mb-2">Catalog Size</p>
          <p className="text-4xl font-bold gradient-text">{stats.fileSizeKb}</p>
        </div>
      </div>
